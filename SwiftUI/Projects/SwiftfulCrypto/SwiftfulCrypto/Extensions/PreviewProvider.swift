...
class DeveloperPreview {
    ...
    let statisticModel1 = StatisticModel(title: "Market Cap", value: "$12.5B", percentageChange: 25.34)
    let statisticModel2 = StatisticModel(title: "TotalVolume", value: "$1.23Tr")
    let statisticModel3 = StatisticModel(title: "Portfolio Value", value: "$50.2k", percentageChange: -3.43)
}
