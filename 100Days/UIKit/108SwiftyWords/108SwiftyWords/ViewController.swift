...
//  108SwiftyWords
//
//  Created by Mirko Braic on 22/04/2020.
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        // lower priority means view is more likely to strech. Content compression priority determines how likely view is to be compressed
        ...
        NSLayoutConstraint.activate([
            // layoutMarginsGuide is inside safeAreaLayoutGuide with added margins
        ...
        for row in 0..<4 {
            for column in 0..<5 {
                // when giving a position to a view, constraints are added automatically
